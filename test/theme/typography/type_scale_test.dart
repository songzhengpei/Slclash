...
void main() {
  test('the 17 semantic roles match the frozen type scale', () {
    final cases = <(TextStyle, double, double, FontWeight, String?)>[
      ...
      (SlclashTypeScale.navigationLabel, 11, 1.0, FontWeight.w500, null),
      (SlclashTypeScale.badgeLabel, 11, 1.0, FontWeight.w600, null),
