...
void main() {
  test('all Material text slots match the frozen mapping', () {
    ...
    final cases = <(TextStyle?, double, double, FontWeight)>[
      ...
      (theme.headlineMedium, 22, 1.2727, FontWeight.w600),
      (theme.headlineSmall, 22, 1.2727, FontWeight.w600),
      (theme.titleLarge, 20, 1.3, FontWeight.w600),
      (theme.titleMedium, 16, 1.375, FontWeight.w500),
      (theme.titleSmall, 15, 1.4667, FontWeight.w500),
      (theme.bodyLarge, 15, 1.4667, FontWeight.w400),
      (theme.bodyMedium, 13, 1.3846, FontWeight.w400),
      (theme.bodySmall, 11, 1.4545, FontWeight.w400),
      (theme.labelLarge, 14, 1.4286, FontWeight.w500),
