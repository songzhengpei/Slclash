...
void main() {
  ...
  group('ProfileMediaCheckView', () {
    ...
    testWidgets('adapts English controls at 1.5x text on a small phone', (
      tester,
    ) async {
      ...
      final profiles = [
        const Profile(
          id: 1,
          label: 'Long profile name for layout testing',
          autoUpdateDuration: Duration(hours: 24),
        ),
      ];
      ...
      expect(find.text('Node checkup'), findsOneWidget);
